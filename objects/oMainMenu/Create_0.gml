...
menu_options = [
    { title: "FREEPLAY", sub: "Juego libre de las canciones", color: 2, rm: rmFreeplay },       // 2 = Amarillo
    { title: "OPCIONES", sub: "Ajustes del juego", color: 0, rm: rmOptions }, // 0 = Azul
    { title: "CREDITOS", sub: "Info del equipo", color: 1, rm: rmCredits },            // 1 = Rojo
];
